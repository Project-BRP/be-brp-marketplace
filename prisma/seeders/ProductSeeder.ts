  ...
  const products = [
    {
      ...
      storageInstructions:
        'Simpan di tempat yang kering dan sejuk, jauhkan dari jangkauan anak-anak dan sinar matahari langsung.',
    ...
    },
    {
      ...
      productTypeId: 'Pupuk_NPK',
      storageInstructions:
        'Simpan di tempat yang kering dan sejuk, hindari kontak dengan air sebelum digunakan.',
    ...
    },
    {
      ...
      storageInstructions:
        'Kocok sebelum digunakan. Simpan di tempat teduh dan tidak terkena panas langsung.',

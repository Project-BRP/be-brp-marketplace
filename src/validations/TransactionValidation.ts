...
export class TransactionValidation {
  ...
  static readonly EXPORT_CSV: ZodType = z
    .object({
      startYear: z.coerce
        .number({ invalid_type_error: 'Start year tidak valid' })
        .nullish()
        .optional(),
      startMonth: z.coerce
        .number({ invalid_type_error: 'Start month tidak valid' })
        .nullish()
        .optional(),
      startDay: z.coerce
        .number({ invalid_type_error: 'Start day tidak valid' })
        .nullish()
        .optional(),
      endYear: z.coerce
        .number({ invalid_type_error: 'End year tidak valid' })
        .nullish()
        .optional(),
      endMonth: z.coerce
        .number({ invalid_type_error: 'End month tidak valid' })
        .nullish()
        .optional(),
      endDay: z.coerce
        .number({ invalid_type_error: 'End day tidak valid' })
        .nullish()
        .optional(),
    })
    .superRefine((data, ctx) => {
